...
- **Map 1:**
    - Commentary blockers.
        - [ ] [**Image**](https://i.imgur.com/TMHwGhl.jpg) **Replace with versus only clip.**
        - [ ] [**Image Album**](https://imgur.com/a/qCxEK88) **Replace with versus only clip. The ones covering the windows below can remain in campaign.**
        - [ ] [**Image**](https://i.imgur.com/9elsiZc.jpg) **Replace with versus only clip.**
...
- **Map 2:**
    - Commentary blockers.
    - [ ] _forklift_roof
        - [**Image**](https://imgur.com/2lJuxwB) **Add clip to prevent players going OOB.**
    - [ ] _nav_exitsign
...
- **Map 4:**
    - Commentary blocker.
        - [ ] [**Image Album**](https://i.imgur.com/1Vauyfc.jpg) **Replace with a versus only clip.**
    - [ ] _booster_barnbeam1
    - [ ] _booster_barnbeam2
    - [ ] _booster_barnbeam3
    - [ ] _booster_barnbeam4
...
- **Map 2:**
    - Commentary blockers.
        - [ ] [**Image**](https://imgur.com/a/R4W2R4G) **Remove entirely.**
        - [ ] [**Image**](https://i.imgur.com/Ajjl3fA.jpg) **Replace with versus only infected clip.**


- **Map 3:**
    - Commentary blockers.
        - [ ] [**Image**](https://i.imgur.com/QxGKEfQ.jpg) **Replace with versus only clip.**

- **Map 4:**
    - Commentary blocker.
        - [ ] [**Image**](https://i.imgur.com/oLsskjO.jpg) **Replace with versus only clip**
...
- **Map 1/4/5:**
    - Commentary blocker.
        - [ ] [**Image**](https://i.imgur.com/F3zFbx1.jpg) **Remove entirely.**
            - **Nav fix.**
            - **Remove prop.**
    - [ ] _booster_ginnytop
    - [ ] _booster_ginnyjon
...
- **Map 2/3:**
    - Commentary blockers.
        - [ ] [**Image**](https://i.imgur.com/LLQPt1t.jpg) Replace with versus only clip.
        - [ ] [**Image**](https://i.imgur.com/z7ecrCA.jpg) Replace with versus only clip.
            - **Nav fix.**
        - [ ] [**Image**](https://i.imgur.com/yZik5X1.jpg) Remove entirely.
            - **Nav fix.**
    - [ ] _commonhop_ducatelroof
    - [ ] _vent_roofa
    - [ ] _vent_roofb
        - [**Image**](https://imgur.com/qnmgXnq) **Replace with 2 new clips.**
    - [ ] _nav_rubblewalla
    - [ ] _nav_rubblewallb
    - [ ] _nav_silo_witch1
    - [ ] _nav_silo_witch2
...
- **Map 2:**
    - Commentary blockers.
        - [ ] [**Image**](https://i.imgur.com/gmu4XvF.jpg) **Replace with versus only clips.**
...
- **Map 3:**
    - Commentary blockers.
        - [ ] [**Image**](https://i.imgur.com/M0Ct4Ge.jpg) **Replace with versus only clips.**
        - [ ] [**Image Album**](https://imgur.com/a/sfKCf8o) **Remove entirely.**
            - **Nav fix on the second truck.**
    - [ ] _commonhop_overpass
...
- **Map 1:**
    - Commentary blockers.
        - [ ] [**Image**](https://i.imgur.com/NymRXIa.jpg) **Remove entirely.**
        - [ ] [**Image**](https://i.imgur.com/cETw6ZU.jpg) **Replace with versus only clip.**
        - [ ] [**Image Album**](https://imgur.com/a/28uEDLQ) **Replace with versus only clips.**
    - [ ] _commonhop_awning
    - [ ] _cliprework_emptylargerooms
        - **Clip only the right room.**
        - **Remove props from left room.**
    - [x] _fence_onea
    - [x] _fence_oneb
    - [x] _fence_two
...
- **Map 2:**
    - Commentary blockers.
        - [ ] [**Image**](https://i.imgur.com/D04AEHQ.jpg) **Replace with versus only clip.**
    - [ ] _booster_yawningman
    - [ ] _booster_littleroof
    - [ ] _nav_windowrecess
    - [ ] _booster_cementlips
...
- **Map 2:**
    - Commentary blockers.
        - [ ] [**Image**](https://i.imgur.com/ZXc12Ar.jpg) **Remove entirely.**
        - [ ] [**Image**](https://i.imgur.com/KaFu7pV.jpg) **Replace with versus only clip.**
        - [ ] [**Image**](https://i.imgur.com/XRe2gtb.jpg) **Replace with versus only clip.**
        - [ ] [**Image**](https://i.imgur.com/OriCGgE.jpg) **Replace with versus only clip.**
    - [x] _subwaymount_in
    - [x] _subwaymount_out
    - [ ] _nav_tankjukepipes
    - [ ] _booster_pipe
